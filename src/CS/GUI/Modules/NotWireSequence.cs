public static class NotWireSequence
{
    public static GuiElement[][] GuiElements = new GuiElement[][]
    {
        ...
        new GuiRow[]
        {
            new GuiUpDown("FirstWire", OnChange, 1, 1, 3)
        },
        new GuiRow[]
        {
            new GuiUpDown("SecondWire", OnChange, 1, 1, 3)
        },
        new GuiRow[]
        {
            new GuiUpDown("ThirdWire", OnChange, 1, 1, 3)
        },
        new GuiRow[]
        {
